...
class Test{
   var CHINESE_YEAR_CODE = [
    ...
    public var CHINESE_NEW_YEAR_DATE = [20210212, 20220201, 20230122, 20240210, 20250129,
    ...
    public function test(year, month, day){
        ...
        var x = CHINESE_NEW_YEAR_DATE[1];
        var newYearDateY = CHINESE_NEW_YEAR_DATE[year - 2021]/10000;
        System.println(newYearDateY);
    }
    
    /**
     * 获取公历对应的农历日期
     */
    public function getLunarDate_2(year, month, day){
        var lunarYear;
        var lunarMonth;
        var lunarDay = 0;
        var leapMonth;
